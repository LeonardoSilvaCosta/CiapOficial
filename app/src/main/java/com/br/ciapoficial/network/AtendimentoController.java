...
public class AtendimentoController {
    ...
    private String urlAtendimentos = BASE_API_URL + "/atendimentos";
    ...
    public void registrar(Context context, Atendimento atendimento, final IVolleyCallback callback) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, urlAtendimentos,
    ...
    public void listar(Context context, final IVolleyCallback callback) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, urlAtendimentos,
                new Response.Listener<String>() {
                    @SneakyThrows
                    @Override
                    public void onResponse(String response) {
    ...
    public void atualizar(Context context, final Atendimento atendimento, final IVolleyCallback callback) {

        RequestQueue queue = Volley.newRequestQueue(context);
        sharedPreferences = context.getSharedPreferences(FILE_NAME, Context.MODE_PRIVATE);
        String token = sharedPreferences.getString("token", "");

        String urlServicosComPathVariable = urlAtendimentos + "/" + atendimento.getId();
